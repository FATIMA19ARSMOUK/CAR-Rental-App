...
def valider(): 
        messagebox.showinfo(title="valider",message=" votre domande de locaton de cette voiture a été envoyée " )
def more_info1():
    root.withdraw()
    ...
    def next():
            ...
            def back1():
                login.destroy()  
                new_file.deiconify()  
            customtkinter.CTkButton(login,text="valider",command=valider).place(x=450,y=630)
